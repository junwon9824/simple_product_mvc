...
<%--       <%@ include file="/WEB-INF/views/common/confirm.jsp" %>
 --%>      <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          <div class="row my-2">
            <h2 class="text-secondary px-5">  ${article.code}</h2>
          </div>
          <div class="row">
            <div class="col-md-8">
              <div class="clearfix align-content-center">
                ...
                />
                <p>
                  <span class="fw-bold">${article.id}</span> <br />
                  <span class="text-secondary fw-light"> ${article.model}   </span>
                </p>
              </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
              ...
              <c:if test="${userinfo.userId eq article.id}">
	              ...
	              <form id="form-no-param" method="get" action="${root}/board">
				      ...
				      <input type="hidden" id="articleno" name="articleno" value="${article.code}">
				  </form>
